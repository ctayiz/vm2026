  ...
  return (
    <form action={formAction} className={compact ? "space-y-1" : "space-y-2"}>
      ...
      <div className={cn("flex items-center", compact ? "gap-1" : "gap-2")}>
        <OptionButton value="HOME_WIN" label={homeShort} selected={current === "HOME_WIN"} locked={locked} compact={compact} />
        <OptionButton value="DRAW" label="X" selected={current === "DRAW"} locked={locked} compact={compact} />
        <OptionButton value="AWAY_WIN" label={awayShort} selected={current === "AWAY_WIN"} locked={locked} compact={compact} />
      </div>
